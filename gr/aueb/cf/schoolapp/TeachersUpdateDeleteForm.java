...
public class TeachersUpdateDeleteForm extends JFrame {
	...
	public TeachersUpdateDeleteForm() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(TeachersUpdateDeleteForm.class.getResource("/resources/eduv2.png")));
		...
		lblNewLabel_1.setBounds(26, 87, 66, 17);
		panel.add(lblNewLabel_1);
		lblNewLabel_1.setForeground(new Color(128, 0, 0));
		lblNewLabel_1.setFont(new Font("Tahoma", Font.BOLD, 14));
		
		JLabel lblNewLabel = new JLabel("ID");
		lblNewLabel.setBounds(69, 10, 23, 14);
